...
class CafeForm(FlaskForm):
    ...
    location_url = StringField('Locaiton URL', validators=[URL()])
    ...
    powerourlet_rating = SelectField('power outlet rating', choices=[('🔌', '🔌'), ('🔌🔌', '🔌🔌'), ('🔌🔌🔌', '🔌🔌🔌'), ('🔌🔌🔌🔌', '🔌🔌🔌🔌'), ('🔌🔌🔌🔌🔌', '🔌🔌🔌🔌🔌')])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', 'a', newline='', encoding='utf-8') as file:
            ...
            format_open_time = form.open_time.data.strftime('%-I%p').lstrip('0')
            format_close_time = form.close_time.data.strftime('%-I%p').lstrip('0')
            csv_writer.writerow([
                form.cafe.data, 
